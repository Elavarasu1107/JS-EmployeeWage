...
}
{
    try
    {
        let employeePayroll = new EmployeePayroll(1, "Elavarasu", 20000, "M", new Date("7/6/2022").toLocaleDateString(), "abc123@gmail.com", 654321);
        console.log(employeePayroll.Employee());
        employeePayroll = new EmployeePayroll(2, "JayaSudha", 25000, "F", new Date("10/12/2021").toLocaleDateString(), "xyz@gmail.com", 654321);
        console.log(employeePayroll.Employee());
        employeePayroll.id = 3;
        employeePayroll.name = "Appusamy";
        employeePayroll.salary = 20000.150;
        employeePayroll.gender = "M";
        employeePayroll.startDate = new Date("1-2-2022").toLocaleDateString();
